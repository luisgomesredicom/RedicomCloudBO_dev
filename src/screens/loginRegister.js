                    ...
                    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                        <KeyboardAvoidingView style={{flexGrow: 1,width: '100%'}}>
                            ...
                            <View style={{flexGrow: 1}}>
                                ...
                                <View style={{marginTop: 'auto',paddingTop: theme.containerPadding,paddingHorizontal: theme.containerPadding,paddingBottom: theme.containerPadding + Math.max(insets.bottom)}}>
                                    <View>
